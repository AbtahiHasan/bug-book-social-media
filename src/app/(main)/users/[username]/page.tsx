...
import { FollowerInfo, getUserDataSelect, TUser } from "@/lib/types";
...
export const generateMetadata = async ({
  ...
  return { title: `${user.displayName} @${username}` };
};
...
const UserProfile = ({ user, loggedInUserId }: UserProfileProps) => {
  ...
  return (
    <div className="h-fit space-y-5 rounded-2xl bg-card p-5 shadow-sm">
      <UserAvatar
